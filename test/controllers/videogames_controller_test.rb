...
class VideogamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create videogame" do
    assert_difference('Videogame.count') do
      post videogames_url, params: { videogame: { description: @videogame.description, genre: @videogame.genre, publisher: @videogame.publisher, title: @videogame.title } }
    end
  ...
  test "should update videogame" do
    patch videogame_url(@videogame), params: { videogame: { description: @videogame.description, genre: @videogame.genre, publisher: @videogame.publisher, title: @videogame.title } }
