...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { title: @collection.title, videogame_id: @collection.videogame_id } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { title: @collection.title, videogame_id: @collection.videogame_id } }
